...
public class RealmeThem extends javax.swing.JFrame {
    ...
    public RealmeThem() {
        ...
        list.add(new Danhsach1("Realme 11pro ", "Androi ", "Chơi game",  "12G","521G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 14990000, "/icon/realme-note-50-black-thumb-600x600.jpg"));
        list.add(new Danhsach1(" Realme C30s", "Androi ", "Chơi game", "6G", "128G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 2290000, "/icon/rm2.jpg"));
        list.add(new Danhsach1("Realme C51", "Androi", "Chơi game", "4G", "64G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 3290000, "/icon/rm3.jpg"));
        list.add(new Danhsach1("Realme C51 ", "Androi", "Chơi game", "3G", "64G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 2490000, "/icon/rm4.jpg"));
        list.add(new Danhsach1("Realme C51  ", "Androi ", "Chơi game", "3G", "64G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 2290000, "/icon/rm5.jpg"));
        View();
        ViewTable();
    }
     public void View(){
...
//         setImage(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RealmeThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RealmeThem().setVisible(true);
            }
        });
    }
