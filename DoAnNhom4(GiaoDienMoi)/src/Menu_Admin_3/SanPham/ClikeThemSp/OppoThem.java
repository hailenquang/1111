...
public class OppoThem extends javax.swing.JFrame {
    ...
    public OppoThem() {
       initComponents();
        ...
        list.add(new Danhsach1(" Oppo A18 ", "Androi ", "Chơi game",  "4G","64G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 3090000, "/image/oppo a18.jpg"));
        list.add(new Danhsach1(" Điện thoại OPPO A38 6GB", "Androi ", "Chơi game", "6G", "128G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 4190000, "/icon/oppo a38.jpg"));
        list.add(new Danhsach1("OPPO A57 64GB", "Androi", "Chơi game", "4G", "64G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 3290000, "/icon/oppo a57.jpg"));
        list.add(new Danhsach1("OPPO Find N2 Flip 5G ", "Androi", "Chơi game", "8G", "256G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 15790000, "/icon/oppo find n2 flip.jpg"));
        list.add(new Danhsach1("OPPO Find N3 Flip 5G  ", "Androi ", "Chơi game", "12G", "256G",
                "Sac sieu nhanh", "Cảm ứng siêu nhậy ", 22990000, "/icon/oppo find n3.jpg"));
        View();
        ViewTable();
